  ...
  <header class="relative">
    ...
    <div class="no-print mb-8 flex items-center justify-end gap-2">
      ...
      <a
        ...
        class="flex items-center rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-500 transition-colors hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400 dark:hover:bg-slate-800"
